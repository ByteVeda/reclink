...
- **Threshold tuning matters.** Start at 0.85 and lower the threshold if you need higher recall, or raise it if you need higher precision. Use the [evaluation API](/docs/api/evaluation) to measure.
...
- **[String Metrics API](/docs/api/string-metrics)** -- Complete metric reference
- **[Pipeline API](/docs/api/pipeline)** -- All pipeline builder methods

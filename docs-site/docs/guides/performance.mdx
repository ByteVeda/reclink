...
- **[Batch Operations API](/api/batch-operations)** -- `cdist`, `match_best`, `match_batch` reference
- **[Index API](/api/indexes)** -- BkTree, VpTree, NgramIndex, MmapNgramIndex, MinHashIndex
- **[Pipeline API](/api/pipeline)** -- All blocking strategies and builder methods
- **[Scoring API](/api/scoring)** -- CompositeScorer and presets

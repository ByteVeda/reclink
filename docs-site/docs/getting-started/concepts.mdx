...
Different algorithms suit different languages and use cases. See the [Phonetic API reference](/api/phonetic) for details.
...
- **[String Metrics API](/api/string-metrics)** — Full reference for all metrics
- **[Pipeline API](/api/pipeline)** — Complete pipeline configuration
- **[Name Matching Guide](/guides/name-matching)** — End-to-end tutorial

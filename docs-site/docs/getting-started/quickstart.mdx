...
- **[API Reference](/api/string-metrics)** — Full function reference
- **[Guides](/guides/name-matching)** — End-to-end tutorials
- **[Playground](/playground)** — Try functions interactively in your browser

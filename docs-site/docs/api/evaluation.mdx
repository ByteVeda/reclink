...
- [Pipeline](/docs/api/pipeline) -- build record linkage pipelines that produce the results evaluated here
- [Scoring & Presets](/docs/api/scoring) -- composite scorers for standalone matching
- [Concepts](/docs/getting-started/concepts) -- background on the record linkage pipeline stages

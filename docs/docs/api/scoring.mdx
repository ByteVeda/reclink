...
- [String Metrics](/api/string-metrics) -- all available metric names for `CompositeScorer`
- [Batch Operations](/api/batch-operations) -- `match_best` and `match_batch` for single-metric matching
- [Pipeline](/api/pipeline) -- use comparators and classifiers for full record linkage workflows
- [Evaluation](/api/evaluation) -- measure quality of matching results

...
- **[Pipeline API](/api/pipeline)** -- All builder methods including `block_custom`, `compare_custom`, `classify_custom`
- **[Batch Operations API](/api/batch-operations)** -- `cdist`, `match_best`, `match_batch` with custom scorers
